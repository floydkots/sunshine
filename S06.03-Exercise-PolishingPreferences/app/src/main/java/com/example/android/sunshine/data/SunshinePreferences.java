...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sharedPreferences.getString(prefLocationKey, defaultLocation);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String prefUnitsMetric = context.getString(R.string.pref_units_metric);
        String prefUnit = sharedPreferences.getString(prefUnitsKey, "");
        return prefUnit.equals(prefUnitsMetric);
    }
